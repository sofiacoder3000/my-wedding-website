...
const CardPersonChat: NextPage<Props> = (props) => {
  ...
  return (
    <div className="w-full bg-white rounded-lg dark:bg-gray-800 dark:border-gray-700 space-x-3 pt-4">
      <div className="flex flex-col items-center pb-10">
        ...
        <div className="flex mt-4 space-x-3 md:mt-6">
          <a 
            href={url}
            target="_blanck"
            className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 dark:text-white border-solid border-2 border-emerald-200 rounded-lg tracking-wider"
          >WhatsApp</a>
        </div>
      </div>
    </div>
